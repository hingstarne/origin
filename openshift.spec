...
%{!?commit:
%global commit 722dc40f35a9904c4dd27577a84125e026c7c25b
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# OpenShift specific ldflags from hack/common.sh os::build:ldflags
%{!?ldflags:
%global ldflags -X github.com/openshift/origin/pkg/version.majorFromGit 0 -X github.com/openshift/origin/pkg/version.minorFromGit 0+ -X github.com/openshift/origin/pkg/version.versionFromGit v0.0.6 -X github.com/openshift/origin/pkg/version.commitFromGit 722dc40 -X github.com/GoogleCloudPlatform/kubernetes/pkg/version.gitCommit 496be63 -X github.com/GoogleCloudPlatform/kubernetes/pkg/version.gitVersion v0.17.1-804-g496be63
}
...
- Automatic commit of package [openshift] release [0.0.6]. (arne-
  kristian.hingst@amadeus.com)
- Automatic commit of package [openshift] release [0.0.5]. (arne-
  kristian.hingst@amadeus.com)
- Automatic commit of package [openshift] release [0.0.4]. (arne-
  kristian.hingst@amadeus.com)
- Automatic commit of package [openshift] release [0.0.3]. (arne-
  kristian.hingst@amadeus.com)
- Automatic commit of package [openshift] release [0.0.2]. (arne-
  kristian.hingst@amadeus.com)
